...
// //Aula Arrays em States - Usando ID - Modulo 3 aula 16
// const Page = ()=> {
//   const [itemInput, setitemInput] = useState('');
//   const [list, setList] = useState<ToDoItem[]>([
//     {id: 1, label: 'Fazer deve de casa', checked: false },
...
// //Aula Arrays em States - ALterar - Modulo 3 aula 15
// const Page = ()=> {
//   const [itemInput, setitemInput] = useState('');
//   const [list, setList] = useState<ToDoItem[]>([
