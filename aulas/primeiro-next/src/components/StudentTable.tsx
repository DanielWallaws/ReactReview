            ...
            <table className="w-full border border-gray-600 rounded-md overflow-hidden">
                ...
                <tbody>
                    {students.map(item => (
                        ...
                        <tr key={item.id} className="text-gray-800 bg-gray-300 border-b border-gray-400 ">
                            <td className="p-3 item-center">
                            ...
                            <td>
                                {item.active && <div className="px-2 py-1 inline-block rounded-md border border-green-800 bg-green-600 text-white text-xs">Activate</div>}
